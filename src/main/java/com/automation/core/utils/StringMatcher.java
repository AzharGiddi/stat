...
import com.automation.core.exceptions.AutomationError;
...
public abstract class StringMatcher {
	...
	protected StringMatcher(String stringToMatch) {
	 ...
	 * @return
	 */
	public abstract boolean match(String actual);
	...
	public static StringMatcher get(String type, String stringToMatch) {
		try {
			...
			Method m = getMethod(StringMatcher.class, type);
