...
import com.nissan.automation.core.NAFJexlContext;
...
/*		@SuppressWarnings("unchecked")
		...
		public static <T> T eval(String expression, Map<? extends String, ? extends Object> context)
			...
			try {
				JexlEngine jexlEngine = new JexlBuilder().create();
				JexlExpression expr = jexlEngine.createExpression(expression);
				JexlContext jc = new NAFJexlContext(context);
		...
		public static List<String> getStringList(List<ExtWebElement> listExtWebElement) {

			return listExtWebElement.stream().map(ele -> ele.getText().trim()).collect(Collectors.toList());
