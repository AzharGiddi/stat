Feature: GoodWill Regression Restricted Parts scenarios

  Background: Pre-Conditions: Set up Repair Option for Restricted Parts
  ...
  @Parallel @Regression @RestrictedParts1
  ...
  Scenario: Test1 Restricted Part Sceanrio where NAM is less than DCAL and WL is less than DCAL and WL is greater than NAM, Case should auto approved.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | Powertrain    | 1N6AA0EC7FN513355 | false              | Restricted Parts  |
  ...
  @Parallel @Regression @Test3 @sheettc1 @RestrictedParts1
  Scenario: Test1b Restricted Part Sceanrio where NAM is less than DCAL and WL is less than DCAL and WL is greater than NAM, Case should auto approved.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | CVT           | 3N1AB7AP3GL665428 | false              | Restricted Parts  |
    * Admin fetches vehiclewarranty details
    When Login as ServiceManager
    * ServiceManager clicks on New GoodWill request
    * selects the ro from the SELECT THE REPAIR ORDER table
  ...
  @Parallel @Regression @Test3123 @sheettc1 @RestrictedParts1
  Scenario: Test1c Restricted Part Sceanrio where NAM is less than DCAL and WL is less than DCAL and WL is greater than NAM, Case should auto approved.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | Basic         | 1N6AD0EV3FN755780 | false              | Restricted Parts  |
    * Admin fetches vehiclewarranty details
    When Login as ServiceManager
    * ServiceManager clicks on New GoodWill request
    * selects the ro from the SELECT THE REPAIR ORDER table
  ...
  @Parallel @Regression @Test4ab @sheettc2 @RestrictedParts1
  Scenario: Test2 Restricted Part Sceanrio where NAM is greater than DCAL and WL is less than DCAL and WL is greater than NAM, Case routes to FOM for approval.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | Powertrain    | 1N6AA0EC7FN513355 | true               | Restricted Parts  |
  ...
  @Parallel @Regression @Test4 @sheettc2 @RestrictedParts1
  Scenario: Test2b Restricted Part Sceanrio where NAM is greater than DCAL and WL is less than DCAL and WL is greater than NAM, Case routes to FOM for approval.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | CVT           | 3N1AB7AP3GL665428 | true               | Restricted Parts  |
    #* Verify VCAN creation
    * Admin fetches vehiclewarranty details
    When Login as ServiceManager
    * ServiceManager clicks on New GoodWill request
  ...
  Scenario: Test2c Restricted Part Sceanrio where NAM is greater than DCAL and WL is less than DCAL and WL is greater than NAM, Case routes to FOM for approval.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | Basic         | 1N6AD0EV3FN755780 | true               | Restricted Parts  |
    #* Verify VCAN creation
    * Admin fetches vehiclewarranty details
    When Login as ServiceManager
    * ServiceManager clicks on New GoodWill request
  ...
  @Parallel @Regression @Test5 @Debug @sheettc3 @RestrictedParts1
  ...
  @Regression @Test5 @Debug @sheettc3 @RestrictedParts1
  ...
  @Parallel @Regression @Test5c @Debug @sheettc3 @RestrictedParts1
  ...
  @Regression1 @Test15a @Debug @sheettc3 @RestrictedParts123
  Scenario: Test3 Restricted Part Sceanrio where NAM is less than DCAL and WL is greater than NAM, Case should auto approved.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | CVT           | 3N1AB7AP3GL665428 | false              | Restricted Parts  |
  ...
  @Regression1 @Test7 @sheettc4 @Debug @RestrictedParts
  ...
  @Regression @Test7 @sheettc4 @Debug @RestrictedParts
  ...
  @Regression @Test8 @sheettc5 @RestrictedParts
  ...
  @Regression @Test9 @sheettc6 @RestrictedParts
  Scenario: Test6a Restricted Part Sceanrio where NAM is greater than DCAL, WL is greater than NAM, case routed to FOM, FOM approves.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FW            | CVT           | 3N1AB7AP3GL665428 | true               | Restricted Parts  |
    * Admin fetches vehiclewarranty details
    When Login as ServiceManager
    * ServiceManager clicks on New GoodWill request
    * selects the ro from the SELECT THE REPAIR ORDER table
  ...
  Scenario: Test6b Restricted Part Sceanrio where NAM is greater than DCAL and WL is greater than NAM, case routed to FOM, FOM approves.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FW            | Basic         | 1N6AD0EV3FN755780 | true               | Restricted Parts  |
    * Admin fetches vehiclewarranty details
    When Login as ServiceManager
    * ServiceManager clicks on New GoodWill request
    * selects the ro from the SELECT THE REPAIR ORDER table
  ...
  Scenario: Test6c Restricted Part Sceanrio where NAM is greater than DCAL and WL is greater than NAM, case routed to FOM, FOM approves.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FW            | Powertrain    | 1N6AA0EC7FN513355 | true               | Restricted Parts  |
    * Admin fetches vehiclewarranty details
    When Login as ServiceManager
    * ServiceManager clicks on New GoodWill request
    * selects the ro from the SELECT THE REPAIR ORDER table
  ...
  @Regression @Test11 @sheettc7 @RestrictedParts
  ...
  @Regression @Test11 @sheettc7 @RestrictedParts
  Scenario: Test7d Restricted Part Sceanrio where NAM is greater than DCAL and WL is greater than NAM, Request Grid exception, RAM Approves, case routed to FOM, FOM approves.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FW            | Basic         | 1N6AD0EV3FN755780 | true               | Restricted Parts  |
    * Admin fetches vehiclewarranty details
    ...
    * Login as RAM
    * Open GW case from Pending RAM Actions
    * Enter RAM Comments as "Approve Case"
    * Click on Approve Exception button
    * Verify Thank You text is dislayed.
    * RAM logs out
    * GoodWill Case is assigned to "Warranty Admin"
    * Submit WarrantyLine with below values
  ...
  # test data issue
  @Regression @Test12a @sheettc8 @RestrictedParts @Runnow
  Scenario: Test8 Restricted Part Sceanrio where NAM is greater than DCAL and WL is greater than NAM, case routed to FOM, FOM approves.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FW            | OOW           | 1N4BL2AP6AN471099 | true               | Restricted Parts  |
    * Admin fetches vehiclewarranty details
    When Login as ServiceManager
    * ServiceManager clicks on New GoodWill request
    * selects the ro from the SELECT THE REPAIR ORDER table
  ...
  @Test12 @Regression @RestrictedParts @sheettc12 @RestrictedParts
  Scenario: Test12 Good will case linking with recommended coupon.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | Audio     |        3529 | FG            | Basic         | 1N6AD0EV3FN755780 | false              | Restricted Parts  |
  ...
  @Test14 @Regression @RestrictedParts @sheettc12
  Scenario: Test14 Approved Coupon linking with Good will case with component CVT,coverage type Basic with restricted parts.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | Basic         | 1N6AD0EV3FN755780 | false              | Restricted Parts  |
    * All the active gw cases are resolved
  ...
  @Test16 @Regression @RestrictedParts @sheettc12
  Scenario: Test16 Approved Coupon linking with Good will case with component CVT,coverage type Basic with restricted parts and Nissan amount is greater than DCAl, Nissan Coupn amount is greater than Nissan Amount and WL amount is greater than DCAL.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | Basic         | 1N6AD0EV3FN755780 | true               | Restricted Parts  |
    * All the active gw cases are resolved
  ...
  @Test17 @Regression @RestrictedParts @sheettc12
  Scenario: Test17 Approved Coupon linking with Good will case with component Audio,coverage type Basic with restricted parts and Nissan amount is lesser than DCAl, Nissan Coupn amount is greater than Nissan Amount and WL amount is lesser than DCAL.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | Audio     |        3529 | FG            | Basic         | 1N6AD0EV3FN755780 | false              | Restricted Parts  |
    * All the active gw cases are resolved
  ...
  @Test17b @Regression @RestrictedParts @sheettc12
  Scenario: Test17b Approved Coupon linking with Good will case with component CVT,coverage type Basic with restricted parts and Nissan amount is greater than DCAl, Nissan Coupn amount is greater than Nissan Amount and WL amount is lesser than DCAL.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | Basic         | 1N6AD0EV3FN755780 | true               | Restricted Parts  |
    * All the active gw cases are resolved
  ...
  Scenario: Test18 Linking Approved goodwill coupon with goodwill case at CAManager, Good will case with component CVT,coverage type Basic with restricted parts and Nissan amount is lesser than DCAl, Nissan Coupn amount is greater than Nissan Amount and WL amount is greater than DCAL.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | Audio     |        3529 | FG            | Basic         | 1N6AD0EV3FN755780 | false              | Restricted Parts  |
    #* Verify VCAN creation
  ...
  @Test19 @Regression @RestrictedPartsFailed @sheettc12
  Scenario: Test19 Linking Approved goodwill coupon with goodwill case at CAManager, Good will case with component CVT,coverage type CVT with restricted parts and Nissan amount is greater than DCAl, Nissan Coupn amount is greater than Nissan Amount and WL amount is greater than DCAL.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | CVT           | 3N1AB7AP3GL665428 | false              | Restricted Parts  |
    #* Verify VCAN creation
  ...
  Scenario: Test20 Linking Approved goodwill coupon with goodwill case at CAManager, Good will case with component CVT,coverage type Powertrain with restricted parts and Nissan amount is lesser than DCAl, Nissan Coupn amount is greater than Nissan Amount and WL amount is greater than DCAL.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | CVT       |        3529 | FG            | Powertrain    | 1N6AA0EC7FN513355 | false              | Restricted Parts  |
    #* Verify VCAN creation
  ...
  Scenario: Test22 Linking Recommended goodwill coupon to goodwill casewith component Audio,coverage type Basic with restricted parts and Nissan amount is lesser than DCAl and WL amount is greater than DCAL.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | Audio     |        3529 | FG            | Basic         | 1N6AD0EV3FN755780 | false              | Restricted Parts  |
    * All the active gw cases are resolved
  ...
  Scenario: Test23 Linking Approved goodwill coupon to goodwill case,
    			Good will case with component Audio,coverage type Powertrain with restricted parts and 
    			Nissan amount is lesser than DCAl, Nissan Coupn amount is greater than Nissan Amount and WL amount is greater than DCAL.

    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | Audio     |        3529 | FG            | Powertrain    | 1N6AA0EC7FN513355 | false              | Restricted Parts  |
    * All the active gw cases are resolved
    #* Verify VCAN creation
    * Login into the application as "CAMANAGER"
    * CAMANAGER clicks on "New Goodwill Coupon" from left side menu
  ...
  Scenario: Test24 Linking Approved goodwill coupon to goodwill case,
    			Good will case with component CVT,coverage type Powertrain with restricted parts and 
  ...
  Scenario: Test26 Linking Approved goodwill coupon to goodwill case from other actions, Good will case with component Audio,coverage type Powertrain with restricted parts and Nissan amount is lesser than DCAl, Nissan Coupn amount is lesser than Nissan Amount and WL amount is lesser than DCAL.
    Given Admin creates RO for good will request with below set of details
      | Component | Dealer Code | Coverage_Code | Coverage_Type | VIN               | NissanAmountGTDcal | Vehicle_Component |
      | Audio     |        3529 | FG            | Powertrain    | 1N6AA0EC7FN513355 | false              | Restricted Parts  |
    * All the active gw cases are resolved
  ...
  @Test30
  Scenario: dummy test
    * Login as ServiceManager "Dschar40"
    * ServiceManager clicks on pending SM actions and opend GW case "GW-40002"
    * GoodWill request ui is displayed
    * enters symptom code and diagnosis code
      | Symptom_Code | Diagnosis_Code |
      |         1234 |           1234 |
